...
<div className='w-[250px] h-[50px]  text-[20px] bg-[#f14242] text-[white] flex items-center justify-center rounded-[30px] absolute top-[5%] right-[10px] shadow-lg'>Set Your home Category</div>
<div className='max-w-[900px] overflow-auto  w-[90%] h-[550px]  bg-white flex items-center justify-start flex-col gap-[40px] mt-[30px]  '>
...
<button className="px-[50px] py-[10px] bg-[red] text-[white] text-[18px] md:px-[100px] rounded-lg mt-[20px] absolute right-[5%] bottom-[5px] " onClick={()=>navigate("/listingpage3")} disabled={!category}>Next</button>
